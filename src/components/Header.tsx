...
import { Moon, Twitter, chart-candlestick } from 'lucide-react';
    ...
    <header className="bg-pink-100/80 backdrop-blur-sm fixed w-full top-0 z-50 border-b-2 border-pink-200">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Moon className="w-6 h-6 text-pink-400 wiggle-on-hover" />
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="https://dexscreener.com/solana/So11111111111111111111111111111111111111112" target="_blank" rel="noopener noreferrer">
           <chart-candlestick className="w-6 h-6 text-amber-600 hover:text-amber-700 cursor-pointer transform hover:scale-110 transition-transform" />
         </a>
        </div>
      </div>
    </header>
